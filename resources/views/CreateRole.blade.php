    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <form id="validate_form" method="POST" data-parsley-validate action="/insert/role">
                    @csrf

                    <input type="hidden" id="id" name="id" value="">
                    <div>
                        <x-jet-label for="role" value="{{ __('Add new role') }}" />
                        <x-jet-input id="role" class="block mt-1" type="text" name="role" :value="old('role')" required />
                    </div>
                    ...
                    <div class="mt-4">                           
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            @if(isset($role[0]->Active) && $role[0]->Active == '0')
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            @if(isset($role[0]->Active) && $role[0]->Active == '1')
            ...
            <div id="RoleList">
                <table class="table table-striped table-bordered border-dark text-center">
                    <tr>
                        ...
                        <td class="fw-bolder">Name of the role</td>
...
jQuery("#validate_form").submit(function(e)
{
    ...
    if($('#validate_form').parsley().isValid())
    {
        jQuery.ajax({
            ...
            data:
            {
                deactivate:deactivate, id:id, role:role, _token: '{{csrf_token()}}',
            },
            method: 'POST',
